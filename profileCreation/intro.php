...
<div class="grid-container">
<h1 style="padding:0.5em 0 !important;">Introduce yourself!</h1>
 
    <form name="introduction clearfix">
 ...
 <br>
    <a href="contact.php" class="button grey outline" style="margin-right:1em;">SKIP THIS PAGE</a>
